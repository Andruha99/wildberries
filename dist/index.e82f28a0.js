...
var _wbLogoCm2Png = require("../images/wb_logo_cm2.png");
var _wbLogoCm2PngDefault = parcelHelpers.interopDefault(_wbLogoCm2Png);
var _shoppingcartSvg = require("../images/shoppingcart.svg");
var _shoppingcartSvgDefault = parcelHelpers.interopDefault(_shoppingcartSvg);
var _searchIconPng = require("../images/search-icon.png");
...
function createEl(tag, className, text) {
    ...
    if (className) {
        ...
        // console.log(arr);
        for (let elem of arr)//перебираю классы в массиве из классов
...
wildLogo.src = (0, _wbLogoCm2PngDefault.default);
...
imgCart.src = (0, _shoppingcartSvgDefault.default);
buttonCart.append(imgCart);
const iconLoop = createEl("img", "navbar__loop");
iconLoop.src = (0, _searchIconPngDefault.default);
const iconLoopAct = createEl("img", "navbar__loopAct");
iconLoopAct.src = (0, _searchIconPngDefault.default);
...
document.querySelector("#elastic").oninput = function search() {
    ...
    if (val != "") //если поле инпут не пустое, пол-ль что-то ввел в поиск, то:
    elasticItem.forEach(function(elem) {
        if (elem.innerText.search(val) == -1) //.search(val)-это спец ф-ция , котоая ищет подстроку в строке и проверяет, есть ли там строка.Если да, то возвратит номер строки, если нет, то минус 1
        //    если не нашло такой строки, то я его скрываю:
        elem.classList.add("hide");
        else elem.classList.remove("hide");
    });
    else //если пустое пол-ль ничего не ввел в поиск, то удаляю класс hide:
    elasticItem.forEach(function(elem) {
...
},{"../images/wb_logo_cm2.png":"ip1rF","../images/shoppingcart.svg":"iRHdf","../images/search-icon.png":"bA3tm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ip1rF":[function(require,module,exports) {
module.exports = require("a548d1fff342fa51").getBundleURL("2MSMO") + "wb_logo_cm2.e98cc553.png" + "?" + Date.now();

},{"a548d1fff342fa51":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"iRHdf":[function(require,module,exports) {
module.exports = require("d364da9a5f0551d4").getBundleURL("2MSMO") + "shoppingcart.2c4b3e42.svg" + "?" + Date.now();

},{"d364da9a5f0551d4":"lgJ39"}],"bA3tm":[function(require,module,exports) {
module.exports = require("37c37567982568a").getBundleURL("2MSMO") + "search-icon.5440739f.png" + "?" + Date.now();

},{"37c37567982568a":"lgJ39"}],"gkKU3":[function(require,module,exports) {
...
},{}]},["fyTPu","dV6cC"], "dV6cC", "parcelRequireaad3")
